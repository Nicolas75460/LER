programa {
  funcao inicio() {
    ...
    inteiro quantidade, quantidadeAmais // Variáveis da quantidade e quantidade adicionais
    ...
    se(opcao1 == 1){
      ...
      faca{
        ...
        se(opcao2 == 1){
          ...
          inteiro novaQuantidade[novaQuantidadeItens] // Vetor da quantidade de cada item com o número da quantidade nova total de itens
        ...
        escreva("\nDigite o número do item que quer adicionar ou 0 para continuar: ")
        leia(opcao3)
        
        // Condição se a resposta anterior for diferente de 0
        se(opcao3 != 0){
          limpa()
